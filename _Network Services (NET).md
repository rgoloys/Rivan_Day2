...
~~~cmd
@cmd
ping 10.42.1.10         PC Network Adapter
ping 10.42.1.2		    CoreTAAS
ping 10.42.1.4		    CoreBABA
ping 10.42.100.8		CUCM
ping 10.42.42.1		EDGE - INSIDE
ping 200.0.0.42		    EDGE - OUTSIDE
...
conf t
 ...
 end   || no monitor session 1 ito gagamitin pag ibabalik sa dati
~~~
...
~~~ pag gawa ng user account kay cisco gamit din po encryption
!@CoreTAAS
conf t
 username admin privilege 15 secret pass
 username ens privilege 15 secret pass
 !
...
Windows Server 2022:
  ...
  | Network Adapter 6 | Bridged (Replicate) | 10.42.1.8 /24 |
...
## Web Server
__Configure Web Server (net42.com)__  
1. Internet Information Services Manager
2. Create an `http` mapping for the domain `www.net42.com`
...
__Create Accounts For `net42.com`__
1. Support
2. Admin
3. User
...
~~~
!@cmd SEC-AZURE42
route add 10.0.0.0 mask 255.0.0.0 10.42.1.4 -p
route add 200.0.0.0 mask 255.255.255.0 10.42.1.4 -p
~~~
...
conf t
 ...
 radius server WINRAD
  address ipv4 10.42.1.8 auth-port 1812 acct-port 1813
  key keykeymo
  exit
...
- A Record : utmph.net42.com : 208.8.8.11
